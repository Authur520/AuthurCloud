package com.example.authur.gateway.handler;
...
@Slf4j
public class AuthurGatewayExceptionHandler extends DefaultErrorWebExceptionHandler {

    public AuthurGatewayExceptionHandler(ErrorAttributes errorAttributes, ResourceProperties resourceProperties,
