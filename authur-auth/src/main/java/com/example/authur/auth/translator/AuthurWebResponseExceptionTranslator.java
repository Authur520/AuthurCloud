package com.example.authur.auth.translator;
...
/**
 * @Description: 优化权限异常处理
 * @Author: jibing.Li
 * @Date: 2021/11/1 14:21
 */
@Slf4j
@Component
public class AuthurWebResponseExceptionTranslator implements WebResponseExceptionTranslator {
